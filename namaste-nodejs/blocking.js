...
console.log("========");
crypto.pbkdf2Sync("password", "salt", 50000000, 50, "sha512"); //! This is blocking the main thread
...
// Async Function
crypto.pbkdf2("password", "salt", 5000000, 50, "sha512", (err, key) => { //? this is given to libuuv
